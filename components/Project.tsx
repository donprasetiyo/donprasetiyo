...
const Details = (props: any) => {
    return (
        <div className={`fixed top-0 bottom-0 left-0 right-0 z-[2] bg-[#cfe9eb] border-dotted border-2 border-[#555] rounded-[10px] text-[#555] p-[10px_15px] w-[960px] h-fit m-auto ${props.shown ? 'block' : 'hidden'} max-[1020px]:w-[90%] dark:bg-[#1f4648]`}>
...
const Project = (props: any) => {
    ...
    return (
        <>
            <div className="w-[200px] inline-block align-top bg-[#c3e4e5] text-[#555] cursor-pointer m-[20px] dark:bg-[#1f4648] dark:text-[#fafafa] text-center rounded-[10px] hover:bg-[#a4dada] transition-all duration-[1s] max-[540px]:w-[90%]" onClick={() => openProject()}>
